...
## values pulled from the projection model
 model2_Fabc = 0.687
 model2_Fmsy = 0.854
 model2_SSB0 = 159948
 SSB22 = 42763 
...
model2_BoverBmsy = mods1[[2]]$timeseries$SpawnBio[3:49]/2/(model2_SSB0*0.35)  ## you will need to change this to match your spawning biomass timeseries
model2_FoverFmsy=mods1[[2]]$sprseries$F_report[1:47]/model2_Fmsy  ## you will need to change this to match your F timeseries

plot.phase.plane(SSB0=model2_SSB0,Fabc=model2_Fabc,Fmsy=model2_Fmsy,BoverBmsy=model2_BoverBmsy, FoverFmsy=model2_FoverFmsy,xlim=c(0,5),ylim=c(0,1.5),header="Pacific cod 2021 Model 21.1",eyr=2023)  ## the xlim and ylim will need to be adjusted as well as the header.
