...
new_SS_dat_filename <- "GOAPcod2022SEPT9.dat"
...
setwd(here::here("functions-old"))

source_files=c("ADD_ENVIRO_DATA.r",
               "BIN_LEN_DATA.r",
               "cond_length_age_corFISH.r",
               "conditional_Length_AGE_cor.r",
               "FIND_AGE_LENGTH_KEY.r",
               "find_AL_map.r",
               "find_ALF.r",
               "FISH_AGE_COMP.r",
               "FORMAT_ACOMP.r",
...
setwd(here::here("functions-old", "ALT_DATA"))
...
setwd(here::here())
source(here::here("functions-old", "SBSS_GET_ALL_DATA_GOA_PCOD_cor.r"))
...
SS_writedat_3.30(new_data, 
                 new_SS_dat_filename, 
                 overwrite = T)


Add_climate(endyr = new_SS_dat_year,
            Old_datafile = new_SS_dat_filename,
            New_datafile = new_SS_dat_filename,
            dir1 = here::here("functions-old", "ALT_DATA"),
            dir2 = here::here())
